# מודול 8: פרויקט מסכם — GitHub Repo Summarizer API
...
- **פונקציונליות (0-3)** — האם ה-API עובד כמצופה? מחזיר סיכומים בפורמט הנכון? מטפל בשגיאות?
- **טיפול בתוכן Repository (0-3)** — האם יש אסטרטגיה חכמה לבחירת קבצים? סינון של קבצים לא רלוונטיים? ניהול גודל ה-context?
- **איכות קוד (0-2)** — האם הקוד קריא ומאורגן? האם יש הפרדה נכונה של concerns?
- **תיעוד (0-2)** — האם ה-README ברור ומלא? האם ההחלטות מוסברות?
